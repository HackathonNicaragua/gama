...
@section('content')
    <body class="hold-transition login-page no-padding no-margin">
    <div class="banner">
        <div class="bg-color">
                ...
                <div id="app" v-cloak>
                    <div class="login-box">
                        <div class="login-logo">                
                            ...
                            <!-- <div>
                                <img src="/img/LogoOficial.png" class="img-responsive" style="width: 250px; height: 250px;margin: auto;" alt="logo">
                            </div> -->
                        </div><!-- /.login-logo -->
